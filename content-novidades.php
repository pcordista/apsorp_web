<section class="novidades jumpline2">
    <div class="container center relative clearContainer">
      <div class="">
        ...
        <!-- CONTROLE LEFT -->
        <div class="novidades_controls_left valign-wrapper">
        ...
        <!-- CONTROLE RIGHT -->
        <div class="novidades_controls_right valign-wrapper">
          <div class="inter_control valign-wrapper">
